...
namespace ControlCatalog.ViewModels
{
    public class TreeViewPageViewModel : ReactiveObject
    {
        ...
        public TreeViewPageViewModel()
        {
            ...
            RemoveParentCommand = ReactiveCommand.Create(RemoveParent);
        }
        ...
        public ReactiveCommand<Unit, Unit> RemoveParentCommand { get; }
        ...
        private void RemoveParent()
        {
            ...
            foreach (Node node in Selection.SelectedItems)
            {
                if (node.Parent?.Parent != null)
                {
                    node.Parent.Parent.RemoveItem(node.Parent);
                }
            }
        }
