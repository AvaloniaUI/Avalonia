...
namespace ControlCatalog.ViewModels
{
    partial class MainWindowViewModel
    {
        ...
        private List<PageItem> _items = new()
        {
            ...
            new PageItem("Flex Panel",() => new FlexPage(), Icons.Grid, "Flexible, CSS-style child layout", "Layout"),
            ...
            new PageItem("Platform Settings",() => new PlatformSettingsPage(), Icons.Tune, "Platform-specific system settings", "Window & Platform"),
