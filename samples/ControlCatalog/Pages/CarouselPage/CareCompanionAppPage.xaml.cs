...
public partial class CareCompanionAppPage : UserControl
{
    ...
    ContentPage BuildTrackPage(AvaCarouselPage carousel, StackPanel dots)
    {
        ...
        for (int ci = 0; ci < barH.Length; ci++)
        {
            ...
            barCol.Children.Add(new Border
            {
                ...
                Background        = new SolidColorBrush(ci == 3
                    ? Colors.White
    ...
    ContentPage BuildResourcesPage(AvaCarouselPage carousel, StackPanel dots)
    {
        ...
        csText.Children.Add(Txt("Connect with others and experts.", 9, FontWeight.Normal, TextMuted, wrap: TextWrapping.Wrap));
    ...
    ContentPage BuildHomeTab()
    {
        ...
        for (int i = 0; i < 7; i++)
        {
            ...
            dayCol.Children.Add(Txt(dayLabels[i], 10, FontWeight.Medium, Colors.White, 0.75, align: TextAlignment.Center));
        ...
        var sTopRow = new StackPanel { Orientation = Orientation.Horizontal, Spacing = 12, VerticalAlignment = VerticalAlignment.Center };
        ...
        var logBtn = StyledButton("Log Symptoms", new SolidColorBrush(Primary), Brushes.White, 44, new CornerRadius(10));
        ...
        root.Children.Add(BuildScheduleItem(
            ...
            iconData:     "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 3c1.93 0 3.5 1.57 3.5 3.5S13.93 13 12 13s-3.5-1.57-3.5-3.5S10.07 6 12 6zm7 13H5v-.23c0-.62.28-1.2.76-1.58C7.47 15.82 9.64 15 12 15s4.53.82 6.24 2.19c.48.38.76.97.76 1.58V19z",
        ...
        root.Children.Add(BuildScheduleItem(
            bulletColor:  Primary,
            iconData:     "M12 2C9.243 2 7 4.243 7 7s2.243 5 5 5 5-2.243 5-5-2.243-5-5-5zM12 14c-5.523 0-10 3.582-10 8a1 1 0 001 1h18a1 1 0 001-1c0-4.418-4.477-8-10-8z",
            iconBg:       PrimaryLight,
            iconFg:       Primary,
            title:        "Dr. Emily Chen",
            time:         "02:30 PM",
