        ...
        var nuspecNuGetSettingsCore = new []
        {
            ...
            new NuGetPackSettings()
            {
                ...
                Dependencies = new []
                {
                    ...
                    new NuSpecDependency() { Id = "Microsoft.Extensions.DependencyModel", TargetFramework = "netstandard1.6", Version = "1.1.0" },
                ...
                Files = netstandardCoreLibrariesNuSpecContent
                    .Concat(netCoreRuntimePlatform)
                    .Concat(win32CoreLibrariesNuSpecContent)
                    .Concat(net45RuntimePlatform)
                    .ToList(),
