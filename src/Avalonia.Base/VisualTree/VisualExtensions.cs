...
namespace Avalonia.VisualTree
{
    ...
    public static class VisualExtensions
    {
        ...
        /// <returns>First ancestor of given type.</returns>
        public static T? FindAncestorOfType<T>(this Visual? visual, bool includeSelf, Func<Visual, bool>? predicate) where T : class
        {
            if (visual is null)
            {
                return null;
        ...
        public static T? FindDescendantOfType<T>(this Visual? visual, bool includeSelf, Func<Visual, bool>? predicate) where T : class
        {
            if (visual is null)
            {
                return null;
        ...
        private static T? FindDescendantOfTypeCore<T>(Visual visual, Func<Visual, bool>? predicate) where T : class
        {
