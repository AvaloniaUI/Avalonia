...
public abstract record DataFormat
{
    ...
    public static DataFormat<byte[]> CreateApplicationFormat(string identifier)
    {
    ...
    /// </param>
    /// <returns>A new <see cref="DataFormat"/>.</returns>
    public static DataFormat<byte[]> CreatePlatformFormat(string identifier)
    {
    ...
    public static DataFormat<byte[]> FromSystemName(string systemName, string applicationPrefix)
    {
