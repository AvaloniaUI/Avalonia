...
/// <summary>
/// Wraps an array of ReadableDataItem (a custom type defined in input.ts) into a <see cref="ISyncDataTransfer"/>.
/// Synchronous only - used to read the drag and drop items.
/// </summary>
/// <param name="jsItems">The array of ReadableDataItem objects.</param>
internal sealed class BrowserDragDataTransfer(JSObject jsItems) : PlatformSyncDataTransfer
{
