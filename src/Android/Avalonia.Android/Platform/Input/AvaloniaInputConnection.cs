...
namespace Avalonia.Android.Platform.Input
{
    internal class AvaloniaInputConnection : Object, IInputConnection
    {
        ...
        // Set false to fall back to full-document extracts if an IME turns out to mishandle
        // partial updates.
        ...
        // Whether the edited field accepts multiple lines (from TextInputOptions.Multiline).
        ...
        internal void UpdateState()
        {
            ...
            if (TryGetStructuredClient(out var structured))
            {
                ...
                // so it never pushes an extract; UpdateSelection below reports it.
        ...
        private ExtractedText CreateExtractedText(IStructuredTextInput structured, int windowStart, int windowEnd)
        {
            ...
            return new ExtractedText
            {
                ...
                // content is still multi-line, and a window may omit a newline the document has.
                Flags = IsMultiline ? 0 : ExtractedTextFlags.SingleLine,
