...
namespace Avalonia.Automation.Provider
{
    ...
    /// elements such as hyperlinks or images. A navigation that implements it lets the text providers
    ...
    /// </summary>
    /// <remarks>
    /// Navigations over uniform text (e.g. a plain TextBox) do not implement this interface, and
