...
namespace Avalonia.Automation
{
    ...
    public sealed class AutomationTextRange : ITextRangeProvider
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomationTextRange"/> class over the
        /// span between two positions of the same navigation.
        /// </summary>
        /// <param name="navigation">The navigation that produced the positions and answers the queries.</param>
        /// <param name="start">The start position.</param>
        /// <param name="end">The end position; may precede <paramref name="start"/>, in which case the range is normalized.</param>
        ...
        public string GetText(int maxLength)
        {
            ...
            // navigation text, so Length still equals the offset difference.
            var end = _end;
            if (maxLength >= 0)
            {
