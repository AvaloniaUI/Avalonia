    ...
    public class DataGridRow : TemplatedControl
    {
        ...
        */
        ...
        protected override void OnTemplateApplied(TemplateAppliedEventArgs e)
        {
            ...
            //        //TODO: ParameterNames
            //        SetDetailsVisibilityInternal(ActualDetailsVisibility, _detailsVisibilityNotificationPending, false);
    ...
    */
    ...
    /*private DataTemplate ActualDetailsTemplate
    {
        get
        {
            ...
            return currentDetailsTemplate != null ? currentDetailsTemplate : OwningGrid.RowDetailsTemplate;
        }
    } */
    ...
    /*private bool AreDetailsVisible
    {
        get
        {
            return DetailsVisibility == Visibility.Visible;
        }
    } */
    ...
    /*private void UnloadDetailsTemplate(bool recycle)
    {
        ...
        SetValueNoCallback(DetailsVisibilityProperty, Visibility.Collapsed);
    } */
    ...
    /*internal void SetDetailsVisibilityInternal(Visibility visibility, bool raiseNotification, bool animate)
    {
        ...
        if (_appliedDetailsVisibility != visibility)
        {
            ...
            SetValueNoCallback(DetailsVisibilityProperty, visibility);
