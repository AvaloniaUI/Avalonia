...
namespace Avalonia.Controls
{
    public partial class DataGrid
    {
        ...
        internal int FrozenColumnCountWithFiller
        {
            get
            {
                ...
                if (ColumnsInternal.RowGroupSpacerColumn.IsRepresented && (count > 0))
        ...
        //TODO
        //RowGroups
        internal void InsertElementAt(int slot, int rowIndex, object item, object groupInfo, bool isCollapsed)
        //internal void InsertElementAt(int slot, int rowIndex, object item, DataGridRowGroupInfo groupInfo, bool isCollapsed)
        {
            ...
            {
                InsertElement(slot, null, _vScrollBar == null || _vScrollBar.IsVisible /*updateVerticalScrollBarOnly*/, false /*isCollapsed*/, isRow);
            }
        }
        ...
        private void AddSlots(int totalSlots)
        {
            ...
            if (slot < totalSlots)
            {
                ...
                OnAddedElement_Phase2(0, _vScrollBar == null || _vScrollBar.IsVisible /*updateVerticalScrollBarOnly*/);
        ...
        private void ExpandSlots(int startSlot, int endSlot, bool isDisplayed, ref int slotsExpanded, ref double totalHeightChange)
        {
            ...
            if (isDisplayed)
            {
                ...
                {
                    Control insertedElement = InsertDisplayedElement(i, false /*updateSlotInformation*/);
        ...
        private double GetSlotElementHeight(int slot)
        {
            ...
            else
            {
                ...
                //return RowHeightEstimate + (GetRowDetailsVisibility(slot) == Visibility.Visible ? RowDetailsHeightEstimate : 0);
            }
        }
    ...
    /*private void CollectionViewGroup_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
    {
        ...
        if (_rowGroupHeightsByLevel != null &&
            ...
            DataConnection.CollectionView.GroupDescriptions != null &&
            DataConnection.CollectionView.GroupDescriptions.Count == _rowGroupHeightsByLevel.Length)
        {
            switch (e.Action)
            {
    ...
    /*private void RefreshRowGroupHeaders()
    {
        if (DataConnection.CollectionView != null
            ...
            && DataConnection.CollectionView.Groups != null
            && DataConnection.CollectionView.GroupDescriptions != null
            && DataConnection.CollectionView.GroupDescriptions.Count > 0)
        {
        ...
        if (rowGroupInfo.Visibility != visibility)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        double heightChange = UpdateRowGroupVisibility(rowGroupInfo, visibility, isDisplayed: false);
                    ...
                    {
                        UpdateRowGroupVisibility(rowGroupInfo, visibility, isDisplayed: false);
                    }
                    UpdateVerticalScrollBar();
                }
            }
    ...
    /*private DataGridRowGroupHeader GenerateRowGroupHeader(int slot, DataGridRowGroupInfo rowGroupInfo)
    {
        ...
        Debug.Assert(DataConnection.CollectionView != null && groupHeader.Level < DataConnection.CollectionView.GroupDescriptions.Count);
        ...
        if (propertyGroupDescription != null)
        {
            ...
            {
                groupHeader.PropertyName = DataConnection.DataType.GetDisplayName(propertyGroupDescription.PropertyName) ?? propertyGroupDescription.PropertyName;
            }
        }
    ...
    /*internal void OnRowGroupHeaderToggled(DataGridRowGroupHeader groupHeader, Visibility newVisibility, bool setCurrent)
    {
        ...
        if (WaitForLostFocus(delegate { OnRowGroupHeaderToggled(groupHeader, newVisibility, setCurrent); }) || !CommitEdit())
        {
            return;
        }
        ...
        UpdateRowGroupVisibility(groupHeader.RowGroupInfo, newVisibility, isDisplayed: true);
    ...
    /*private int GetDetailsCountInclusive(int lowerBound, int upperBound)
    {
        ...
        if (RowDetailsVisibilityMode == DataGridRowDetailsVisibilityMode.Visible)
        {
            ...
            return indexCount - _showDetailsTable.GetIndexCount(lowerBound, upperBound, Visibility.Collapsed) - RowGroupHeadersTable.GetIndexCount(lowerBound, upperBound);
        }
    ...
    {
        EventHandler<DataGridRowDetailsEventArgs> handler = RowDetailsVisibilityChanged;
