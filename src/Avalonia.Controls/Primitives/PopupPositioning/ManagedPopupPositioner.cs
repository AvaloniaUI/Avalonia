    ...
    public class ManagedPopupPositioner : IPopupPositioner
    {
            ...
            PopupPositionerConstraintAdjustment constraintAdjustment, Point offset)
        {
            ...
            if (!FitsInBounds(geo, PopupAnchor.HorizontalMask)
                && constraintAdjustment.HasFlag(PopupPositionerConstraintAdjustment.FlipX))
            {
            ...
            if (constraintAdjustment.HasFlag(PopupPositionerConstraintAdjustment.SlideX))
            {
            ...
            if (constraintAdjustment.HasFlag(PopupPositionerConstraintAdjustment.ResizeX))
            {
            ...
            if (!FitsInBounds(geo, PopupAnchor.VerticalMask)
                && constraintAdjustment.HasFlag(PopupPositionerConstraintAdjustment.FlipY))
            {
            ...
            // If sliding is allowed, try moving the rect into the bounds
            if (constraintAdjustment.HasFlag(PopupPositionerConstraintAdjustment.SlideY))
            {
            ...
            if (constraintAdjustment.HasFlag(PopupPositionerConstraintAdjustment.ResizeY))
            {
                var unconstrainedRect = geo;
