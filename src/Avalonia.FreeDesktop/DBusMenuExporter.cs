            ...
            object GetProperty((NativeMenuItemBase item, NativeMenu menu) i, string name)
            {
                ...
                else if (it is NativeMenuItem item)
                {
                    ...
                    if (name == "shortcut")
                    {
                        ...
                        if (mod.KeyModifiers.HasFlag(KeyModifiers.Control))
                            lst.Add("Control");
                        if (mod.KeyModifiers.HasFlag(KeyModifiers.Alt))
                            lst.Add("Alt");
                        if (mod.KeyModifiers.HasFlag(KeyModifiers.Shift))
                            lst.Add("Shift");
                        if (mod.KeyModifiers.HasFlag(KeyModifiers.Meta))
                            lst.Add("Super");
