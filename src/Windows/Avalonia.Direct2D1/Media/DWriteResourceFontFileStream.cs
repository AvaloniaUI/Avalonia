...
namespace Avalonia.Direct2D1.Media
{
    ...
    public class DWriteResourceFontFileStream : CallbackBase, IDWriteFontFileStream
    {
        ...
        void IDWriteFontFileStream.ReadFileFragment(out IntPtr fragmentStart, ulong fileOffset, ulong fragmentSize, out IntPtr fragmentContext)
        {
            lock (this)
            {
        ...
        void IDWriteFontFileStream.ReleaseFileFragment(IntPtr fragmentContext)
        {
