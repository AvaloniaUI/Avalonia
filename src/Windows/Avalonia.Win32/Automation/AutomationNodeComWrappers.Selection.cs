...
namespace Avalonia.Win32.Automation
{
    internal unsafe partial class AutomationNodeComWrappers
    {
        private static void** InitISelectionProviderVtbl(ComInterfaceEntry* entries, ref int entryIndex)
        {
            ...
            vtbl[idx++] = (delegate* unmanaged<void*, SAFEARRAY**, int>)&ISelectionProviderManagedWrapper.GetSelection;
        ...
        private static void** InitISelectionItemProviderVtbl(ComInterfaceEntry* entries, ref int entryIndex)
        {
            ...
            vtbl[idx++] = (delegate* unmanaged<void*, void**, int>)&ISelectionItemProviderManagedWrapper.GetSelectionContainer;
