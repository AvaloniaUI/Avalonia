...
/*
    internal class WinUiCompositedWindowSurface : EglGlPlatformSurfaceBase, IBlurHost, IDisposable
    {
        ...
        private EglPlatformGraphics _egl;
        private readonly EglGlPlatformSurface.IEglWindowGlPlatformSurfaceInfo _info;
        private IRef<WinUICompositedWindow> _window;
        private BlurEffect _blurEffect;

        public WinUiCompositedWindowSurface(WinUICompositorConnection connection, EglGlPlatformSurface.IEglWindowGlPlatformSurfaceInfo info) : base()
        {
        ...
        {
            var egl = (EglContext)context;
            using (egl.EnsureCurrent())
            {
                ...
                return new CompositionRenderTarget(egl, _window, _info);
            }
        }
        ...
        class CompositionRenderTarget : EglPlatformSurfaceRenderTargetBase
        {
            ...
            public CompositionRenderTarget(EglContext context,
            ...
            public override IGlPlatformSurfaceRenderingSession BeginDrawCore()
            {
                ...
                try
                {
                    ...
                    surface = ((AngleWin32EglDisplay) Context.Display).WrapDirect3D11Texture(texture.GetNativeIntPtr(),
