...
namespace Avalonia.Win32.Automation
{
    ...
    /// range. Every call forwards to that cursor; this type converts between the UIA COM signatures
    /// and the cross-platform ones, and marshals onto the UI thread, since UIA calls arrive on its
    /// own thread.
    /// </summary>
    [GeneratedComClass]
