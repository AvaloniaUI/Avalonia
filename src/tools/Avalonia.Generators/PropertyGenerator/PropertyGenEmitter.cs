        ...
        ref bool firstMember)
    {
        ...
        switch (property.Kind)
        {
            ...
            case GeneratedPropertyKind.Direct:
                ...
                if (!useFieldKeyword)
                {
                    Line(builder, indent, $"private {property.ValueTypeRef} {backingField};");
                }
                Line(builder, indent, $"{property.MemberAccessibility} {property.InheritanceModifiers}partial {property.ValueTypeRef} {property.Name}");
                Line(builder, indent, "{");
                Line(builder, indent + 1, $"get => {backingField};");
                Line(builder, indent + 1, $"{SetterPrefix(property)}set => SetAndRaise({property.Name}Property, ref {backingField}, value);");
                Line(builder, indent, "}");
                break;
