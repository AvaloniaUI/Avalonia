...
namespace Avalonia.Input
{
    ...
    /// </summary>
    public class TouchPadDevice : ITouchPadDevice, IDisposable
    {
        ...
        public TouchPadDevice(Pointer? pointer = null)
        {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private void ProcessRawEvent(RawPointerEventArgs e)
        {
            ...
            var mouse = (TouchPadDevice)e.Device;
            if(mouse._disposed)
                return;
        ...
        private void LeaveWindow(ITouchPadDevice device, ulong timestamp, IInputRoot root, PointerPointProperties properties,
        ...
        private bool MouseDown(ITouchPadDevice device, ulong timestamp, IInputElement root, Point p,
        ...
        private bool MouseMove(ITouchPadDevice device, ulong timestamp, IInputRoot root, Point p, PointerPointProperties properties,
            KeyModifiers inputModifiers)
        {
            device = device ?? throw new ArgumentNullException(nameof(device));
            root = root ?? throw new ArgumentNullException(nameof(root));
        ...
        private bool MouseUp(ITouchPadDevice device, ulong timestamp, IInputRoot root, Point p, PointerPointProperties props,
            KeyModifiers inputModifiers)
        {
            device = device ?? throw new ArgumentNullException(nameof(device));
            root = root ?? throw new ArgumentNullException(nameof(root));
        ...
        private bool MouseWheel(ITouchPadDevice device, ulong timestamp, IInputRoot root, Point p,
