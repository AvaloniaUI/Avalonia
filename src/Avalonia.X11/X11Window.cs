        ...
        IX11OptionsToplevelImplFeature
    {
        ...
        public X11Window(AvaloniaX11Platform platform, IWindowImpl? popupParent, bool overrideRedirect = false)
        {
            ...
            if (_platform.Options.UseXShmFramebuffer is true)
            {
                ...
                void TryInsertX11ShmFramebufferSurface()
                {
                    ...
                    Debug.Assert(_handle == _renderHandle);
                    //Debug.Assert(_x11.DeferredDisplay == _x11.Display);

                    var x11ShmFramebufferSurface = new X11ShmFramebufferSurface(this, _x11.Display, _handle,
                        _renderHandle, visual, depth);
        ...
        private void OnEvent(ref XEvent ev)
        {
            ...
            else if (ev.type == XEventName.XShmCompletionEvent)
            {
                ...
                Debug.Assert(_x11ShmFramebufferSurface != null,
                    "If application can receive the XShmCompletionEvent, that the _x11ShmFramebufferSurface must not be null.");
