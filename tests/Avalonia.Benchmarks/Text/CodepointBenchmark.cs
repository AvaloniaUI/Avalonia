...
/// decoding via <see cref="Codepoint.ReadAt"/>, property accessors (which each
/// construct a new <see cref="UnicodeTrie"/>), and a representative "all
/// properties" pass that approximates what a layout pipeline traversal pays
/// per codepoint.
/// </summary>
[MemoryDiagnoser]
