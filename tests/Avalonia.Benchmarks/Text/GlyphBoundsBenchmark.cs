...
public class GlyphBoundsBenchmark : IDisposable
{
    ...
    private ushort[] _glyphIndices = Array.Empty<ushort>();
    ...
    public void Setup()
    {
        ...
        {
            _glyphIndices[i] = _glyphPool[i % _glyphPool.Length];
        }
    ...
    {
        _font.GetGlyphWidths(_glyphIndices, null, _skBounds.AsSpan(0, GlyphCount));
    }

    [Benchmark]
    public void Table_BoundsOnly()
    {
        _glyphTypeface.TryGetGlyphMetrics(_glyphIndices, _metrics.AsSpan(0, GlyphCount));
    }
    ...
    public void Table_PerRun()
    {
        ...
        _glyphTypeface.TryGetGlyphMetrics(_glyphIndices, metrics);
    }
