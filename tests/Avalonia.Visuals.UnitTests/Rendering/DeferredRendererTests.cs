...
namespace Avalonia.Visuals.UnitTests.Rendering
{
    public class DeferredRendererTests
    {
        ...
        public void Should_Push_Opacity_For_Controls_With_Less_Than_1_Opacity()
        {
            ...
            context.Verify(x => x.DrawRectangle(Brushes.Red, null, new Rect(0, 0, 100, 100), 0, null), Times.Once);
        ...
        public void Should_Not_Draw_Controls_With_0_Opacity()
        {
            ...
            context.Verify(x => x.DrawRectangle(Brushes.Red, null, new Rect(0, 0, 100, 100), 0, null), Times.Never);
        ...
        public void Should_Draw_Transparent_Layer_With_Correct_Opacity()
        {
            ...
            context.Verify(x => x.DrawImage(borderLayer, 0.5, It.IsAny<Rect>(), It.IsAny<Rect>(), BitmapInterpolationMode.Default, null));
        }
