...
namespace Avalonia.Controls.UnitTests
{
    public class ItemsControlTests
    {
        ...
        ////[Fact]
        ////public void Throws_When_Trying_To_Reassign_Items_In_ContainerRealized_Handler()
        ////{
        ////    using var app = Start();
        ...
        ////    Layout(target);
        ////    itemsControl.ContainerRealized += (s, e) =>
        ////    {
        ////        Assert.Throws<InvalidOperationException>(() => itemsControl.Items = new[] { "foo", "bar" });
        ////        ++raised;
        ////    };
        ...
        ////    Assert.Same(items, itemsControl.Items);
        ////}

        ////[Fact]
        ////public void Throws_When_Trying_To_Add_Item_In_ContainerRealized_Handler()
        ////{
        ////    using var app = Start();
        ////    var (target, items, itemsControl) = CreateTarget();
        ////    var raised = 0;
