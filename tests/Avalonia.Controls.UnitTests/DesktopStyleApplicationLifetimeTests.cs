...
namespace Avalonia.Controls.UnitTests
{
    ...
    public class DesktopStyleApplicationLifetimeTests
    {
        ...
        {
            using var _ = UnitTestApplication.Start(new TestServices(dispatcherImpl: new ManagedDispatcherImpl(null)));
        ...
        {
            using var _ = UnitTestApplication.Start(TestServices.StyledWindow.With(dispatcherImpl: CreateDispatcherWithInstantMainLoop()));
            using var lifetime = new ClassicDesktopStyleApplicationLifetime();
