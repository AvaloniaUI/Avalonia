...
namespace Avalonia.IntegrationTests.Appium
{
    public abstract class ComboBoxTests
    {
        ...
        {
            var comboBox = _driver.FindElementByAccessibilityId("BasicComboBox");

            _driver.FindElementByAccessibilityId("ComboBoxSelectFirst").Click();
            Assert.Equal("Item 0", comboBox.GetComboBoxValue());

            comboBox.Click();
            _driver.FindElementByName("Item 1").SendClick();
        ...
        public void Can_Change_Selection_From_Unselected_Using_Mouse()
        {
            ...
            _driver.FindElementByAccessibilityId("ComboBoxSelectionClear").Click();
            Assert.Equal(string.Empty, comboBox.GetComboBoxValue());

            comboBox.Click();
            _driver.FindElementByName("Item 0").SendClick();
        ...
        {
            var comboBox = _driver.FindElementByAccessibilityId("BasicComboBox");
            var wrap = _driver.FindElementByAccessibilityId("ComboBoxWrapSelection");
        ...
        public void Can_Change_Selection_When_Open_With_Keyboard()
        {
            ...
            var item = _driver.FindElementByName("Item 1");
        ...
        public void Can_Change_Selection_When_Open_With_Keyboard_From_Unselected()
        {
            ...
            var item = _driver.FindElementByName("Item 0");
            item.SendKeys(Keys.Enter);
