...
const KeyInfo keyInfos[] =
{
    ...
    { 0x10, AvnPhysicalKeyMediaPlayPause, AvnKeyMediaPlayPause, 0 },
    //{   , AvnPhysicalKeyMediaSelect, 0 },
    //{   , AvnPhysicalKeyMediaStop, 0 },
    { 0x11, AvnPhysicalKeyMediaTrackNext, AvnKeyMediaNextTrack, 0 },
    { 0x12, AvnPhysicalKeyMediaTrackPrevious, AvnKeyMediaPreviousTrack, 0 },
